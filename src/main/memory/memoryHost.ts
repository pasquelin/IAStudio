 ...
 *
 * 🛑 Opened LAZILY: opening a project pays nothing. It is the first assistant TURN that opens —
 * `memoriesOf` asks for a count — so the read of the file is paid once a session, never at boot.
 *
