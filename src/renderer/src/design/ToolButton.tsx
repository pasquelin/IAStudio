...
/**
 * Bouton d'une barre d'outils : icône, état actif, nom accessible porteur du raccourci.
 * Source unique du langage des barres — sans lui, chaque site recopiait la classe active,
 * les attributs d'infobulle et la taille d'icône, et un oubli d'`aria-label` passait
 * inaperçu.
 */
