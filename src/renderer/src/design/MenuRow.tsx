...
type MenuRowBase = {
   ...
   * glyph column then closes rather than standing empty: within one menu the rows either all
   * carry an icon or none does, so no label shifts by a glyph against its neighbour.
   */
  icon?: string
  shortcut?: string
  disabled?: boolean
