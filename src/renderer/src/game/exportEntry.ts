...
export async function startExportedGame(canvas: HTMLCanvasElement): Promise<() => void> {
  ...
  const startExportedGameStep1 = async () => {
    ...
    const startExportedGameStep2 = async () => {
      ...
      const startExportedGameStep3 = async () => {
        ...
        const startExportedGameStep4 = async () => {
          ...
          const startExportedGameStep5 = async () => {
            ...
            const startExportedGameStep6 = async () => {
              ...
              async function swapIfAsked(): Promise<void> {
                ...
                try {
                  ...
                  world = worldFromScene(
                    wanted.id, found, ports, { modules }, 1,
              ...
              const startExportedGameStep7 = async () => {
                ...
                const startExportedGameStep8 = async () => {
                  return () => {
                    stopped = true
                    frames.stop()
                    world.dispose()
                ...
                return startExportedGameStep8()
              }
              return startExportedGameStep7()
            }
            return startExportedGameStep6()
          }
          return startExportedGameStep5()
        }
        return startExportedGameStep4()
      }
      return startExportedGameStep3()
    }
    return startExportedGameStep2()
  }
  return startExportedGameStep1()
}
