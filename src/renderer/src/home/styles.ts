/**
 * Shapes shared by more than one band of the home. Local to `home/` rather than in
 * `design/styles.ts`: these are the page's own rhythm, not the studio's control language, and a
