...
import type { ExportChannels } from '@shared/domain/materialExport'
import type { MaterialSettings, ValueRange } from '@shared/domain/material'
 ...
 */
export function exportChannelsOf({ channels, material }: MaterialState): ExportChannels {
