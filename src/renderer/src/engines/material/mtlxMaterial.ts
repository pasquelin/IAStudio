...
export function mtlxMaterialOf(state: MaterialState, { files }: MtlxMaterialOptions): MtlxDocument {
 ...
 */
function foreignMaterial(payload: MtlxDocument, channels: ChannelSet): MaterialState {
