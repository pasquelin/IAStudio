...
// The 10 000 nodes form ONE held group, so `editorPickable()` answers exactly `objects.values()`:
// what the editor casts against is measured by `individual source representation` below.
