...
/** Groups drawable meshes by the complete key and restores everything below the threshold. */
export function sweep(
  ...
  const { worth, held } = worthyGroups(groups, parented)
  sources.hold(held)
  return worth
}
...
/** Encodes the shadow and negative flags a draw call cannot share. */
