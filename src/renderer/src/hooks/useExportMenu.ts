...
/**
 * Arms a native export row for the tab in FRONT, and for no other. The event goes to the window
 * rather than to a document, and a hidden tab stays mounted: without this, two open skies answer
 * one click of the same row — and both open a folder dialog.
 *
