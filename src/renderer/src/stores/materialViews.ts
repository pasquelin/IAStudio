...
export type MaterialViewsState = {
...
export const useMaterialViews = create<MaterialViewsState>()(set => ({
  inspected: {},
  seams: {},
...
export function seamOf(
  state: Pick<MaterialViewsState, 'seams'>,
  documentId: string,
): SeamReading | null {
...
export function inspectedChannel(
  state: Pick<MaterialViewsState, 'inspected'>,
  documentId: string,
): PbrChannel | null {
