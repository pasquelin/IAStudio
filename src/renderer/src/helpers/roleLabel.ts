...
/**
 * What a role is called on screen, in the words the catalogue already publishes — ADR-21 § A.
 * A family with ONE employment is named by the family alone: the pair says the same word twice.
 */
