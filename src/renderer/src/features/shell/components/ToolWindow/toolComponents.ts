...
export const TOOL_ENTRIES: Record<ToolId, ToolEntry> = {
  assistant: { load: () => import('@/panels/assistant/index'), role: 'actions' },
  layers: { load: () => import('@/panels/layers/index'), role: 'actions' },
  meshes: { load: () => import('@/panels/meshes/index'), role: 'actions' },
  lights: { load: () => import('@/panels/lights/index'), role: 'actions' },
  timeline: { load: () => import('@/panels/timeline/index'), role: 'fill-actions' },
  explorer: { load: () => import('@/panels/explorer/index'), role: 'actions' },
  git: { load: () => import('@/panels/git/index'), role: 'actions' },
  history: { load: () => import('@/panels/history/index'), role: 'actions' },
  scene: { load: () => import('@/panels/scene/index'), role: null },
  guiTree: { load: () => import('@/panels/guiTree/index'), role: null },
  generator: { load: () => import('@/panels/generator/index'), role: null },
  inspector: { load: () => import('@/panels/inspector/index'), role: 'actions' },
  assets: { load: () => import('@/panels/assets/index'), role: 'actions' },
  projects: { load: () => import('@/panels/projects/index'), role: null },
  animations: { load: () => import('@/panels/animations/index'), role: null },
  text: { load: () => import('@/panels/text/index'), role: null },
  context: { load: () => import('@/panels/context/index'), role: 'actions' },
  problems: { load: () => import('@/panels/problems/index'), role: null },
}
