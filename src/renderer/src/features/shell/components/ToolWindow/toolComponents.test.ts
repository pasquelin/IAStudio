...
import { definition as assets } from '@/panels/assets/index'
import { definition as assistant } from '@/panels/assistant/index'
import { definition as explorer } from '@/panels/explorer/index'
import { definition as git } from '@/panels/git/index'
import { definition as history } from '@/panels/history/index'
import { definition as animations } from '@/panels/animations/index'
import { definition as context } from '@/panels/context/index'
import { definition as generator } from '@/panels/generator/index'
import { definition as inspector } from '@/panels/inspector/index'
import { definition as layers } from '@/panels/layers/index'
import { definition as lights } from '@/panels/lights/index'
import { definition as meshes } from '@/panels/meshes/index'
import { definition as problems } from '@/panels/problems/index'
import { definition as projects } from '@/panels/projects/index'
import { definition as guiTree } from '@/panels/guiTree/index'
import { definition as scene } from '@/panels/scene/index'
import { definition as text } from '@/panels/text/index'
import { definition as timeline } from '@/panels/timeline/index'
