...
declare module Jolt {
    ...
    class OrientedBox {
        ...
        OverlapsAABox(inBox: AABox, inEpsilon?: number): boolean;
        OverlapsOrientedBox(inBox: OrientedBox, inEpsilon?: number): boolean;
    ...
    class DefaultBroadPhaseLayerFilter extends BroadPhaseLayerFilter {
        constructor(inFilter: ObjectVsBroadPhaseLayerFilter, inObjectLayer: number);
    }
    class ObjectLayerFilter {
        constructor();
    }
    class SpecifiedBroadPhaseLayerFilter extends BroadPhaseLayerFilter {
        constructor(inBroadPhaseLayer: BroadPhaseLayer);
    }
