...
**977 fichiers dans `src/`, dont 389 de test** (relevé le 9 août au soir, sur `develop` ; `pnpm test`
en exécutait alors **4886 cas**, verts — les `it.each` en portent plusieurs chacun, donc aucun de ces
