...
This reference lists all available **Pixelcut** video generation models and their parameters. Use these parameter names when calling the [Generation API](/api/postgeneratecustom/index.md).
...
| `outputFormat`         | string | No       | `webm_vp9`    | -   | -   | `webm_vp9`, `mov_proresks`, `mkv_vp9`, `gif`                          | Output video format. Leave empty to let Pixelcut choose the best format; transparent output defaults to WebM VP9.   |
