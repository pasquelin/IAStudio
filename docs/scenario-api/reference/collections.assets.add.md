...
`client.collections.assets.add(stringcollectionID, AssetAddParamsparams, RequestOptionsoptions?): AssetAddResponse`
...
- `params: AssetAddParams`
  ...
  - `assetIds: Array<string>`
    ...
    Body param: The ids of the assets to add to the collection. (Max 49 at once)
...
const response = await client.collections.assets.add('collectionId', { assetIds: ['string'] });
