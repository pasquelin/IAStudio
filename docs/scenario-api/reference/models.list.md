...
`client.models.list(ModelListParamsquery?, RequestOptionsoptions?): ModelsCursor<ModelListResponse>`
...
- `query: ModelListParams`
  ...
  - `sortDirection?: "asc" | "desc"`
    ...
    Sort results in ascending (asc) or descending (desc) order. Only used when sortBy is specified. Available for both privacy=public and privacy=private/unlisted.
    For public models, this parameter is ignored when sortBy is not specified or set to score.

    - `"asc"`

    - `"desc"`

  - `status?: "new" | "training" | "trained" | 2 more`
  ...
  - `types?: Array<"flux.1" | "flux.1-lora" | "flux.1-kontext-dev" | 28 more>`

    List of types, comma separated. The parameter "type" and "types" cannot be used together. Can be any of the following values: flux.1, flux.1-lora, flux.1-kontext-dev, flux.1-krea-dev, flux.1-kontext-lora, flux.1-krea-lora, flux.1-composition, flux.1-pro, flux1.1-pro, flux.1.1-pro-ultra, flux.2-dev-lora, flux.2-dev-edit-lora, flux.2-klein-4b-lora, flux.2-klein-9b-lora, flux.2-klein-base-4b-lora, flux.2-klein-base-9b-lora, flux.2-klein-4b-edit-lora, flux.2-klein-9b-edit-lora, flux.2-klein-base-4b-edit-lora, flux.2-klein-base-9b-edit-lora, gpt-image-1, qwen-image-lora, qwen-image-2512-lora, qwen-image-edit-lora, qwen-image-edit-2509-lora, qwen-image-edit-2511-lora, zimage-lora, zimage-turbo-lora, zimage-de-turbo-lora, custom, elevenlabs-voice. Only available when privacy=public
...
for await (const modelListResponse of client.models.list()) {
  console.log(modelListResponse.id);
}
```
