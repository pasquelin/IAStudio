...
`client.generate.describeStyle(GenerateDescribeStyleParamsparams, RequestOptionsoptions?): GenerateDescribeStyleResponse`
...
- `GenerateDescribeStyleResponse`

  - `description: string`

    The style of the given images.
  ...
  - `synthesis: string`
    ...
    A short synthesis that describes the given asset(s) or asset(s) model.
...
const response = await client.generate.describeStyle();
