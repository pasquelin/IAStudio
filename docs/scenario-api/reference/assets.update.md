...
`client.assets.update(stringassetID, AssetUpdateParamsparams, RequestOptionsoptions?): AssetUpdateResponse`
...
- `params: AssetUpdateParams`
  ...
  - `canvas?: string`
    ...
    Body param: The new value for the canvas as a stringified JSON.

  - `description?: string`

    Body param: The new description of the asset.

  - `disableSnapshot?: boolean`

    Body param: If true, no snapshot will be created for this update.

  - `lockExpiresAt?: string`

    Body param: The ISO timestamp when the lock on the canvas will expire.

  - `lockId?: string`

    Body param: The value of the lock to use when updating a locked canvas.

  - `name?: string`

    Body param: The new name for the canvas.

  - `thumbnail?: string`

    Body param: The new thumbnail for the canvas in base64 format string.
