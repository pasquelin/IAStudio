...
`client.collections.update(stringcollectionID, CollectionUpdateParamsparams, RequestOptionsoptions?): CollectionUpdateResponse`
...
- `params: CollectionUpdateParams`
  ...
  - `name?: string`
    ...
    Body param: The new name for the Collection

  - `thumbnail?: string`

    Body param: The AssetId of the image you want to use as a thumbnail for the collection. Set to null to unset the thumbnail.
