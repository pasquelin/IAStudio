...
`client.models.examples.list(stringmodelID, ExampleListParamsquery?, RequestOptionsoptions?): ExampleListResponse`
...
const examples = await client.models.examples.list('modelId');
