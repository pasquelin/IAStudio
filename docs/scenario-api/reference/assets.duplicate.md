...
`client.assets.duplicate(stringassetID, AssetDuplicateParamsparams, RequestOptionsoptions?): AssetDuplicateResponse`
...
- `params: AssetDuplicateParams`
  ...
  - `targetProjectId?: string`
    ...
    Body param: The id of the project to copy the asset to. If not provided, the asset will be copied to the canvas project.
...
const response = await client.assets.duplicate('assetId');
