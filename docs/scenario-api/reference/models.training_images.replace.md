...
`client.models.trainingImages.replace(stringtrainingImageID, TrainingImageReplaceParamsparams, RequestOptionsoptions?): TrainingImageReplaceResponse`
...
- `params: TrainingImageReplaceParams`
