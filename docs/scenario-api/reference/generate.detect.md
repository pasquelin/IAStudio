...
`client.generate.detect(GenerateDetectParamsparams, RequestOptionsoptions?): GenerateDetectResponse`
...
- `params: GenerateDetectParams`
  ...
  - `image: string`
    ...
    Body param: The image to be used to detect. Must reference an existing AssetId or be a data URL.

  - `modality: "canny" | "depth" | "grayscale" | 7 more`

    Body param: Modality to detect
  ...
  - `factor?: number`
    ...
    Body param: Contrast factor for Grayscale detector

  - `highThreshold?: number`

    Body param: High threshold for Canny detector

  - `keypointThreshold?: number`

    Body param: How polished is the surface? 0 is like a rough surface, 1 is like a mirror

  - `lowThreshold?: number`

    Body param: Low threshold for Canny detector

  - `maxThreshold?: number`

    Body param: Maximum threshold for Grayscale conversion

  - `minThreshold?: number`

    Body param: Minimum threshold for Grayscale conversion

  - `removeBackground?: boolean`

    Body param: Remove background for Grayscale detector

### Returns

- `GenerateDetectResponse`
...
const response = await client.generate.detect({ image: 'image', modality: 'canny' });
