...
`client.models.create(ModelCreateParamsparams, RequestOptionsoptions?): ModelCreateResponse`
...
- `params: ModelCreateParams`
  ...
  - `baseModelId?: string`
    ...
    Body param: The ID of the base model to use as a starting point for the training (example: "flux.1-dev")
  ...
  - `collectionIds?: Array<string>`
    ...
    Body param: List of collection IDs to add the model to
