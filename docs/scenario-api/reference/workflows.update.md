...
`client.workflows.update(stringworkflowID, WorkflowUpdateParamsparams, RequestOptionsoptions?): WorkflowUpdateResponse`
...
- `params: WorkflowUpdateParams`
  ...
  - `after?: string`
    ...
    Body param: The after asset of the workflow. Set to null to unset the after asset.

  - `before?: string`

    Body param: The before asset of the workflow. Set to null to unset the before asset.

  - `bypassLock?: boolean`

    Body param: Set to true to bypass the lock and save a locked workflow without unlocking it first.
    Only the author or a project admin can use this.

  - `description?: string`

    Body param: The description of the workflow.

  - `editorInfo?: Record<string, unknown>`

    Body param: The UI data about the workflow. This is managed by scenario webapp.

  - `flow?: Array<Flow>`

    Body param: The flow of the workflow.
  ...
  - `inputs?: Array<Input>`
    ...
    Body param: The inputs of the workflow.
  ...
  - `isLocked?: boolean`
    ...
    Body param: Set to true to lock the workflow, false to unlock.
    Only the author or a project admin can change this.

  - `name?: string`

    Body param: The name of the workflow.

  - `outputAssetKinds?: Array<"3d" | "audio" | "document" | 5 more>`

    Body param: The output asset kinds of the workflow.
  ...
  - `privacy?: "private" | "public" | "unlisted"`
    ...
    Body param: The privacy of the workflow.
  ...
  - `shortDescription?: string`
    ...
    Body param: A short description of the workflow.

    Used for display in the App UI.

  - `status?: "draft" | "ready"`

    Body param: The status of the workflow.
  ...
  - `tagSet?: Array<string>`
    ...
    Body param: The tag set of the workflow.

  - `thumbnail?: string`

    Body param: The thumbnail asset of the workflow. Set to null to unset the thumbnail.
