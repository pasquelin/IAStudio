...
`client.models.copy(stringmodelID, ModelCopyParamsparams, RequestOptionsoptions?): ModelCopyResponse`
...
- `params: ModelCopyParams`
  ...
  - `copyAsTrained?: boolean`
    ...
    Body param: If set to true, the training data will be copied

  - `copyExamples?: boolean`

    Body param: true by default, the example images will be copied
...
const response = await client.models.copy('modelId');
