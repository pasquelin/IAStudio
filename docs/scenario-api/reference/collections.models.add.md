...
`client.collections.models.add(stringcollectionID, ModelAddParamsparams, RequestOptionsoptions?): ModelAddResponse`
...
- `params: ModelAddParams`
  ...
  - `modelIds: Array<string>`
    ...
    Body param: The ids of the models to add to the collection. (Max 49 at once)
