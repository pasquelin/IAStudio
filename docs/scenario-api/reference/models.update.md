...
`client.models.update(stringmodelID, ModelUpdateParamsparams, RequestOptionsoptions?): ModelUpdateResponse`
...
- `params: ModelUpdateParams`
  ...
  - `classSlug?: string`
    ...
    Body param: The slug of the class you want to use (ex: "characters-npcs-mobs-characters"). Set to null to unset the class

  - `concepts?: Array<Concept>`

    Body param: The concepts is required for composition models. With one or more loras

    Only applicable to Flux based models.
  ...
  - `epoch?: string`
    ...
    Body param: The epoch of the model. Only available for flux.1-lora and flux.1-kontext-lora based models.
  ...
  - `name?: string`
    ...
    Body param: The model's name (ex: "Cinematic Realism").
  ...
  - `negativePromptEmbedding?: string`
    ...
    Body param: Add a negative prompt embedding to every model's generation

  - `parameters?: Parameters`

    Body param: The parameters to use for the model's training
  ...
  - `promptEmbedding?: string`
    ...
    Body param: Add a prompt embedding to every model's generation

  - `shortDescription?: string`

    Body param: The model's short description (ex: "This model generates highly detailed cinematic scenes.").

    If not set, the model's short description will be automatically generated when starting training based on training data.

  - `thumbnail?: string`

    Body param: The AssetId of the image you want to use as a thumbnail for the model (example: "asset_GTrL3mq4SXWyMxkOHRxlpw"). Set to null to unset the thumbnail

  - `type?: "custom" | "elevenlabs-voice" | "flux.1" | 28 more`

    Body param: The model's type (ex: "flux.1-lora").
...
const model = await client.models.update('modelId');
