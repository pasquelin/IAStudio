...
`client.assets.unlock(stringassetID, AssetUnlockParamsparams, RequestOptionsoptions?): AssetUnlockResponse`
...
- `params: AssetUnlockParams`
  ...
  - `forceUnlock?: boolean`
    ...
    Body param: If true, no need to pass a lockId.

  - `lockId?: string`

    Body param: The value of the lock on this canvas.
...
const response = await client.assets.unlock('assetId');
