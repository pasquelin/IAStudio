...
`client.models.train.action(stringmodelID, TrainActionParamsparams, RequestOptionsoptions?): TrainActionResponse`
...
- `params: TrainActionParams`

  - `action: "cancel"`

    Body param: The action to perform on the model training
...
const response = await client.models.train.action('modelId', { action: 'cancel' });
