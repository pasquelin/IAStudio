...
`client.generate.embed(GenerateEmbedParamsparams, RequestOptionsoptions?): GenerateEmbedResponse`
...
- `params: GenerateEmbedParams`
  ...
  - `text: string`
    ...
    Body param: The text to embed. Must be a non-empty string.
...
const response = await client.generate.embed({ text: 'text' });
