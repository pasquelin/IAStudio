...
`client.models.description.update(stringmodelID, DescriptionUpdateParamsparams, RequestOptionsoptions?): DescriptionUpdateResponse`
...
- `params: DescriptionUpdateParams`

  - `description: string`

    Body param: The markdown description of the model (ex: `# My model`). Set to `null` to delete the description.
...
const description = await client.models.description.update('modelId', {
  description: 'description',
});
