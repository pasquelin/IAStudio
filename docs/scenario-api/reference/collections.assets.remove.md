...
`client.collections.assets.remove(stringcollectionID, AssetRemoveParamsparams, RequestOptionsoptions?): AssetRemoveResponse`
...
- `params: AssetRemoveParams`

  - `assetIds: Array<string>`

    Body param: The ids of the assets to remove from the collection. (Max 49 at once)
...
const asset = await client.collections.assets.remove('collectionId', { assetIds: ['string'] });
