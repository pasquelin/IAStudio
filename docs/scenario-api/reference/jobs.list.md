...
`client.jobs.list(JobListParamsquery?, RequestOptionsoptions?): JobsCursor<JobListResponse>`
...
- `query: JobListParams`
  ...
  - `authorId?: string`
    ...
    The authorId of the jobs to return. Optional.

  - `hideResults?: boolean`

    If false, jobs containing the hideResults param will be not returned. Optional.

  - `pageSize?: number`

    The number of items to return in the response. The default value is 10, maximum value is 200, minimum value is 1
  ...
  - `status?: "pending" | "queued" | "warming-up" | 5 more`

    The status of the jobs to return. Optional.
  ...
  - `type?: "assets-download" | "model-training" | "flux-model-training" | 33 more`

    The type of the jobs to return. If "types" is defined, "type" will be ignored. Optional.
  ...
  - `types?: Array<"assets-download" | "model-training" | "flux-model-training" | 33 more>`

    The types of the jobs to return, comma separated. If "types" is defined, "type" will be ignored. Can be any of the following values: assets-download, model-training, flux-model-training, musubi-model-training, inference, pixelate, embed, remove-background, vectorize, canvas-export, image-generation, image-prompt-editing, caption, generate-prompt, describe-style, translate, detection, restyle, repaint, reframe, segment, skybox-base-360, skybox-upscale-360, skybox-hdri, skybox-3d, texture, upscale, upscale-skybox, upscale-texture, flux, openai-image-generation, upload, custom, splat, mesh-preview-rendering, workflow. Optional.
...
for await (const jobListResponse of client.jobs.list()) {
  console.log(jobListResponse.createdAt);
}
```
