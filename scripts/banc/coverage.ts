...
export const COVERAGE: Record<ActionName, readonly string[]> = {
  ...
  'assets.counts': ['1.3'],
  'assets.listMissingProjectAssets': ['43.3'],
  ...
  'post.reset': ['59.14'],
  'post.addEffectKeyframe': ['59.15'],
  'post.removeEffectKeyframe': ['59.16'],
  ...
  'settings.triggerSettingAction': ['57.2'],
  'accounts.list': ['43.8'],
