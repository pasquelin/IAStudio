 ...
 *
 * PNG en niveaux de gris 8 bits : la couleur ne sert à rien pour juger une échelle. L'encodeur
 * est `scripts/png.mjs`, partagé avec les vignettes de modèles.
 *
...
import { GREYSCALE, pngOf } from './png.mjs'
...
function textureOf(variant) {
  ...
  return pngOf(SIZE, SIZE, GREYSCALE, raw)
}
...
for (const variant of VARIANTS) {
  ...
  writeFileSync(file, textureOf(variant))
